...
ESX.RegisterServerCallback('k4rma-ilegais:requestDBItems', function(source, cb)
	if not hasSqlRun then
...
RegisterServerEvent('k4rma-ilegais:buyItem')
AddEventHandler('k4rma-ilegais:buyItem', function(itemName, amount, zone)
	...
	if amount < 0 then
		print('k4rma-ilegais: ' .. xPlayer.identifier .. ' attempted to exploit the shop!')
		return
	end
