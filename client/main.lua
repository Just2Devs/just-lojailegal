...
Citizen.CreateThread(function()
	...
	ESX.TriggerServerCallback('just-ilegais:requestDBItems', function(ShopItems)
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'shop', {
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'shop_confirm', {
			...
			if data2.current.value == 'yes' then
				TriggerServerEvent('just-ilegais:buyItem', data.current.item, data.current.value, zone)
			end
...
AddEventHandler('just-ilegais:hasEnteredMarker', function(zone)
...
AddEventHandler('just-ilegais:hasExitedMarker', function(zone)
...
Citizen.CreateThread(function()
	while true do
		...
		if isInMarker and not HasAlreadyEnteredMarker then
			...
			TriggerEvent('just-ilegais:hasEnteredMarker', currentZone)
		end
		if not isInMarker and HasAlreadyEnteredMarker then
			HasAlreadyEnteredMarker = false
			TriggerEvent('just-ilegais:hasExitedMarker', LastZone)
		end
	end
end)
